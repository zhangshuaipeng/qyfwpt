...
<table width="100%" cellspacing="0" cellpadding="0" border="1" align="center" class="datatable">
    <tbody>
        <tr>
            ...
            <td><htm:text name="name" title="角色号" datatype="STRING" format="CODE" required="true" maxlength="32" width="256" unbitted="true"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="value"/>
</td>
            <td><htm:text name="value" title="角色名" datatype="STRING" required="true" maxlength="32" width="400"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="comment"/>
</td>
            <td><htm:checkbox name="comment" title="动态虚拟角色" dictid="yes"/>
</td>
        </tr>
        <tr>
 ...
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="role.cmd?$ACTION=list" args="system" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
