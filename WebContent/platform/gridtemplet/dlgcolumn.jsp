...
function Ok()
{
	...
	oActiveEl = CreateNamedElement( oEditor, oActiveEl, 'INPUT', {name:"$" + key,id:"$" + key, type: "button", style:"border:0px;"} ) ;

	SetAttribute( oActiveEl, 'value', value) ;
	SetAttribute( oActiveEl, 'ctrltype', "column" ) ;
...
<htm:form name="EAPForm" action=""  method="POST"> 
 ...
 <htm:grid id="list" name="list" title="列表" gridid="title"/>
