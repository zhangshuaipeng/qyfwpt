...
<div class="formarea" style="width:720px;">
  <div>
	...
	<div class="formbody">
	<htm:hidden name="type" defaultv="class"/>
 <htm:hidden name="operand"/>
 <htm:hidden name="item"/>
...
<table width="100%" cellspacing="0" cellpadding="0" border="1" align="center" class="datatable">
    <tbody>
        ...
        <tr>
            ...
            <td><htm:select name="catalog" title="类名" required="true" dictid="allclasses" onchange="refreshField('script');"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="script"/>
</td>
            <td><htm:select name="script" title="类方法" required="true" dictid="methods" parents="catalog:classname"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><htm:text name="scope" title="元数据作用域" datatype="STRING"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><htm:text name="onafter" title="后置规则" datatype="STRING"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="remark"/>
</td>
            <td><htm:text name="remark" title="说明" datatype="STRING" width="256"/>
</td>
        </tr>
        <tr>
            <td align="center" colspan="2"><htm:button name="save" value="保存" type="CUSTOM" showtype="BUTTON" icon="save.gif" display="ICONTEXT" href="saveclass" target="_self"/>
 <htm:button name="update1" value="修改" type="CUSTOM" showtype="BUTTON" icon="update.gif" display="ICONTEXT" href="updateclass" target="_self"/>
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="business.cmd?$ACTION=listclass" args="system,module" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
