...
<div class="formarea" style="width:100%px;">
  <div>
	...
	<div class="formbody">
	<htm:hidden name="type" defaultv="script"/>
 <htm:hidden name="system"/>
 <htm:hidden name="module"/>
...
<table width="100%" cellspacing="0" cellpadding="0" border="1" align="center" class="datatable">
    <tbody>
        ...
        <tr>
            ...
            <td><htm:textarea name="script" title="后台脚本" datatype="STRING" required="true" height="300"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="params"/>
</td>
            <td><htm:text name="params" title="输入参数" datatype="STRING"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" colspan="2"><htm:button name="save" value="保存" type="CUSTOM" showtype="BUTTON" icon="save1.gif" display="ICONTEXT" href="savescript" target="_self"/>
 <htm:button name="update1" value="修改" type="CUSTOM" showtype="BUTTON" icon="update.gif" display="ICONTEXT" href="updatescript" target="_self"/>
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="business.cmd?$ACTION=listscript" args="system,module" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
