...
<table width="100%" cellspacing="0" cellpadding="0" border="1" align="center" class="datatable">
    <tbody>
        <tr>
            ...
            <td><htm:select name="fieldset" title="域集合号" required="true" dictid="fieldsetbypull" parents="system,module,cmd" unbitted="true"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="caption"><htm:title name="retfield"/>
</td>
            <td><htm:text name="retfield" title="返回单个值时直接赋值的域" datatype="STRING" width="400"/>
</td>
        </tr>
        <tr>
 ...
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="pull.cmd?$ACTION=list" args="system,module,cmd,$TABLE" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
