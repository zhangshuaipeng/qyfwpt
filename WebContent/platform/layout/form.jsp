...
<table width="100%" cellspacing="0" cellpadding="0" border="1" align="center" class="datatable">
    <tbody>
        <tr>
            ...
            <td><htm:text name="code" title="框架号" datatype="STRING" format="CODE" required="true" maxlength="32" width="256" unbitted="true"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="name"/>
</td>
            <td><htm:text name="name" title="框架名" datatype="STRING" required="true" maxlength="32" width="400"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="style"/>
</td>
            <td><htm:select name="style" title="式样" required="true" dictid="layoutstyle"/>
</td>
        </tr>
        <tr>
 ...
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="layout.cmd?$ACTION=list" args="system,module" target="_self" uncheck="Y"/>
</td>
        </tr>
        <tr>
            <td colspan="2"><htm:grid id="item" name="item" title="布局条目" required="true" height="400" gridid="item"/>
</td>
        </tr>
    </tbody>
</table>
