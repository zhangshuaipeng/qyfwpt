...
<table width="100%" cellspacing="0" cellpadding="0" border="1" align="center" class="datatable">
    <tbody>
        <tr>
            ...
            <td><htm:select name="code" title="模块号" required="true" dictid="systemmodule" parents="sys:system" expkey="true" unbitted="true" onchange="refreshField('action');"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><htm:select name="action" title="请求号" required="true" dictid="controls" parents="sys:system,code:module" expkey="true"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" colspan="2"><htm:button name="save" value="保存" type="CUSTOM" showtype="BUTTON" icon="save.png" display="ICONTEXT" href="savesysmod" target="_self"/>
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="modulenav.cmd?$ACTION=list" args="system,sys" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
