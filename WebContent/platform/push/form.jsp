...
<table width="100%" cellspacing="0" cellpadding="0" border="1" align="center" class="datatable">
    <tbody>
        <tr>
            ...
            <td><htm:select name="fieldset" title="域集合号" required="true" dictid="fieldsetbyaction" parents="system,module,cmd" unbitted="true"/>
</td>
        </tr>
        <tr>
 ...
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="push.cmd?$ACTION=list" args="system,module,cmd,$TABLE" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
