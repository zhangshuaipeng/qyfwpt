  ...
  <div>
    ...
    <tbody>
        <tr>
            ...
            <td><htm:readonly name="code" title="用户号"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="name"/>
</td>
            <td><htm:readonly name="name" title="用户名"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="password"/>
</td>
            <td><htm:password name="password" title="密码" maxlength="20"/>
</td>
        </tr>
        <tr>
            <td align="center" colspan="2"><htm:button name="update" value="修改密码" type="CUSTOM" showtype="BUTTON" icon="update.gif" display="ICONTEXT" href="updatepwd" target="_self"/>
