...
<table width="100%" cellspacing="0" cellpadding="0" border="1" align="center" class="datatable">
    <tbody>
        <tr>
            ...
            <td><htm:text name="code" title="域集合编号" datatype="STRING" format="CODE" required="true" maxlength="32" unbitted="true"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="name"/>
</td>
            <td><htm:text name="name" title="域集合名称" datatype="STRING" required="true" width="400"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="metadata"/>
</td>
            <td><htm:select name="metadata" title="元数据" dictid="metadata" parents="system,module"/>
</td>
        </tr>
        <tr>
 ...
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="fieldset.cmd?$ACTION=list" args="system,module,page,$TABLE" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
