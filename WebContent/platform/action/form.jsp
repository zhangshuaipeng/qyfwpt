...
<table class="datatable" border="1" cellspacing="0" cellpadding="0" width="100%" align="center">
    <tbody>
        <tr>
            ...
            <td><htm:text name="code" title="操作号" datatype="STRING" format="CODE" required="true" width="160" unbitted="true"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="name"/>
</td>
            <td><htm:text name="name" title="操作名" datatype="STRING" required="true" maxlength="32" width="400" unbitted="true"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="type"/>
</td>
            <td><htm:select name="type" title="操作类型" required="true" dictid="actiontype" expkey="true" onchange="refreshField('href');"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="showtype"/>
</td>
            <td><htm:select name="showtype" title="显示类型" required="true" dictid="actionshowtype"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><htm:checkbox name="uncheck" title="提交时不进行有效性校验" dictid="yes"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><htm:text name="width" title="窗口宽度" datatype="INTEGER" format="INTEGER" maxlength="4" width="108"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="height"/>
</td>
            <td><htm:text name="height" title="窗口高度" datatype="INTEGER" format="INTEGER" maxlength="4" width="108"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="operand"/>
</td>
            <td><htm:select name="operand" title="操作范围" dictid="operandscope"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="icon"/>
</td>
            <td><htm:select name="icon" title="按钮图标" required="true" dictid="ICON"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="target"/>
</td>
            <td><htm:select name="target" title="运行目标" dictid="target"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="callback"/>
</td>
            <td><htm:textarea name="callback" title="回调处理" datatype="STRING" maxlength="512" height="100"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="caption"><htm:title name="hidemobile"/>
</td>
            <td><htm:checkbox name="hidemobile" title="移动端隐藏" dictid="yes"/>
</td>
        </tr>
        <tr>
 ...
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="page.cmd?$ACTION=list" args="system,module,$TABLE" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
