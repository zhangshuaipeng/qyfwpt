...
FCKCommands.GetUrl = function(ShowType) {
	var url;
	if (ShowType=="field")	{
		url = '../../platform/field.cmd?$ACTION=listfields&system=' + FCKConfig.system 	+ '&module=' + FCKConfig.module + '&templet=' + FCKConfig.templet;

		return url;
	}
	if (ShowType=="action")	{
		url = '../../platform/action.cmd?$ACTION=listaction&system=' + FCKConfig.system	+ '&module=' + FCKConfig.module + '&templet=' + FCKConfig.templet;

		return url;

	}
	if (ShowType=="title")	{
		url = '../../platform/field.cmd?$ACTION=listtitles&system=' + FCKConfig.system + '&module=' + FCKConfig.module + '&templet=' + FCKConfig.templet;

		return url;
	}

	if (ShowType=="column") {
		url = '../../platform/gridtemplet.cmd?$ACTION=listcols&system=' + FCKConfig.system + '&module=' + FCKConfig.module + '&gridid=' + FCKConfig.grid + "&templet=" + FCKConfig.templet;

		return url;
	}
	
	if (ShowType=="coltitle") {
		url = '../../platform/gridtemplet.cmd?$ACTION=listtitle&system=' + FCKConfig.system + '&module=' + FCKConfig.module + '&gridid=' + FCKConfig.grid + "&templet=" + FCKConfig.templet;
		return url;
	}

	if (ShowType=="query") {
		url = '../../platform/gridtemplet.cmd?$ACTION=listquery&system=' + FCKConfig.system + '&module=' + FCKConfig.module + '&gridid=' + FCKConfig.grid + "&templet=" + FCKConfig.templet;
		return url;
	}
	
	if (ShowType=="colaction") {
		url = '../../platform/gridtemplet.cmd?$ACTION=listaction&system=' + FCKConfig.system + '&module=' + FCKConfig.module + '&gridid=' + FCKConfig.grid + "&templet=" + FCKConfig.templet;

		return url;
	}

	if (ShowType=="include") {
		url = '../../cms/templet.cmd?$ACTION=listsubpage&siteid=' + FCKConfig.siteid;

		return url;
	}

	if (ShowType=="content") {
		url = '../../cms/templet.cmd?$ACTION=tags&siteid=' + FCKConfig.siteid;
...
FCKCommands.GetCommand = function( commandName )
{
	...
	switch ( commandName )
	{
		...
		case 'Link'			: oCommand = new FCKDialogCommand( 'Link'		, FCKLang.DlgLnkWindowTitle		, 'dialog/website/chx_link.jsp'		, 400, 300 ) ; break ;
		...
		case 'Image'		: oCommand = new FCKDialogCommand( 'Image'		, FCKLang.DlgImgTitle			, 'dialog/website/fck_image.jsp'		, 450, 390 ) ; break ;
		...
		// form command
		case 'FieldTag'			: oCommand = new FCKDialogCommand( 'FieldTag'		, FCKLang.FieldTag		, FCKCommands.GetUrl('field')		, 600, 400 ) ; break ;
		case 'ActionTag'		: oCommand = new FCKDialogCommand( 'ActionTag'		, FCKLang.ActionTag		, FCKCommands.GetUrl('action')		, 600, 400 ) ; break ;
		case 'FieldTitleTag'	: oCommand = new FCKDialogCommand( 'FieldTitleTag'	, FCKLang.FieldTitleTag	, FCKCommands.GetUrl('title')		, 600, 400 ) ; break ;

		case 'ColumnTag'		: oCommand = new FCKDialogCommand( 'ColumnTag'		, FCKLang.ColumnTag		, FCKCommands.GetUrl('column')		, 600, 400 ) ; break ;
		case 'ColumnTitleTag'	: oCommand = new FCKDialogCommand( 'ColumnTitleTag'	, FCKLang.ColumnTitleTag, FCKCommands.GetUrl('coltitle')	, 600, 400 ) ; break ;
		case 'QueryTag'			: oCommand = new FCKDialogCommand( 'QueryTag'		, FCKLang.QueryTag		, FCKCommands.GetUrl('query')		, 600, 400 ) ; break ;
		case 'ColumnActionTag'	: oCommand = new FCKDialogCommand( 'ColumnActionTag', FCKLang.ColumnActionTag	, FCKCommands.GetUrl('colaction')		, 600, 400 ) ; break ;

		case 'IncludeTag'	: oCommand = new FCKDialogCommand( 'IncludeTag', FCKLang.IncludeTag	, FCKCommands.GetUrl('include')		, 600, 400 ) ; break ;
		case 'ContentTag'	: oCommand = new FCKDialogCommand( 'ContentTag', FCKLang.ContentTag	, FCKCommands.GetUrl('content')		, 600, 400 ) ; break ;
