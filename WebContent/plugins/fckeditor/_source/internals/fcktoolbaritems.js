...
FCKToolbarItems.GetItem = function( itemName )
{
	...
	switch ( itemName )
	{
		...
		case 'FieldTag'			: oItem = new FCKToolbarButton( 'FieldTag'		, FCKLang.FieldTag, null, null, null, true, 'FieldTag' ) ; break ;
		case 'ActionTag'		: oItem = new FCKToolbarButton( 'ActionTag'		, FCKLang.ActionTag, null, null, null, true, 'ActionTag' ) ; break ;
		case 'FieldTitleTag'	: oItem = new FCKToolbarButton( 'FieldTitleTag'	, FCKLang.FieldTitleTag, null, null, null, true, 'FieldTitleTag' ) ; break ;

		case 'ColumnTitleTag'	: oItem = new FCKToolbarButton( 'ColumnTitleTag', FCKLang.ColumnTitleTag, null, null, null, true, 'ColumnTitleTag' ) ; break ;
		case 'QueryTag'			: oItem = new FCKToolbarButton( 'QueryTag'		, FCKLang.QueryTag, null, null, null, true, 'QueryTag' ) ; break ;
		case 'ColumnActionTag'	: oItem = new FCKToolbarButton( 'ColumnActionTag', FCKLang.ColumnActionTag, null, null, null, true, 'ColumnActionTag' ) ; break ;
		case 'ColumnTag'		: oItem = new FCKToolbarButton( 'ColumnTag'	, FCKLang.ColumnTag, null, null, null, true, 'ColumnTag' ) ; break ;

		case 'IncludeTag'		: oItem = new FCKToolbarButton( 'IncludeTag'	, FCKLang.IncludeTag, null, null, null, true, 'IncludeTag' ) ; break ;
		case 'ContentTag'		: oItem = new FCKToolbarButton( 'ContentTag'	, FCKLang.ContentTag, null, null, null, true, 'ContentTag' ) ; break ;
