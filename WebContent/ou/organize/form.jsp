...
<table class="datatable" border="1" cellspacing="0" cellpadding="0" width="100%" align="center">
    <tbody>
        <tr>
            ...
            <td><htm:text name="code" title="组织编码" datatype="STRING" format="CODE" required="true" maxlength="32" width="200"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="name"/>
</td>
            <td><htm:text name="name" title="组织名称" datatype="STRING" required="true" maxlength="64" width="400"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="orgtype"/>
</td>
            <td><htm:select name="orgtype" title="组织类型" required="true" dictid="organizetype"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><htm:text name="notes" title="备注" datatype="STRING" maxlength="255" width="400"/>
</td>
        </tr>
        <tr>
 ...
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="organize.cmd?$ACTION=list" args="pcode" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
