...
<div class="formarea" style="width:680px;">
  <div>
	<div class="formhead">
...
<table width="100%" cellspacing="0" cellpadding="0" border="1" align="center" class="datatable">
    <tbody>
        <tr>
            ...
            <td><htm:text name="code" title="职务号" datatype="STRING" format="CODE" required="true" maxlength="32" width="256"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="name"/>
</td>
            <td><htm:text name="name" title="职务名称" datatype="STRING" required="true" maxlength="64" width="400"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><htm:text name="notes" title="职务说明" datatype="STRING" maxlength="255" width="400"/>
</td>
        </tr>
        <tr>
 ...
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="job.cmd?$ACTION=list" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
