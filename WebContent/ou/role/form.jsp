...
<div class="formarea" style="width:720px;">
 ...
 <htm:hidden name="roletype" defaultv="A"/>
...
<table class="datatable" border="1" cellspacing="0" cellpadding="0" width="100%" align="center">
    <tbody>
        <tr>
            ...
            <td><htm:text name="code" title="编码" datatype="STRING" format="CODE" required="true" maxlength="32" width="256" unbitted="true"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><htm:textarea name="notes" title="说明" datatype="STRING" maxlength="255" width="400" height="50"/>
</td>
        </tr>
        <tr>
 ...
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="role.cmd?$ACTION=list" args="$TABLE" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
