...
<div class="formarea" style="width:720px;">
  <div>
    ...
    <tbody>
        <tr>
            ...
            <td><htm:text name="code" title="域号" datatype="STRING" format="CODE" required="true" maxlength="32" width="256" unbitted="true"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="name"/>
</td>
            <td><htm:text name="name" title="域名" datatype="STRING" required="true" maxlength="32" width="400"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="orgcode"/>
</td>
            <td><htm:select name="orgcode" title="绑定组织" required="true" dictid="organizes"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="addr"/>
</td>
            <td><htm:text name="addr" title="域地址" datatype="STRING" required="true" maxlength="128"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="callback"/>
</td>
            <td><htm:text name="callback" title="回调请求" datatype="STRING" required="true" maxlength="128"/>
</td>
        </tr>
        <tr>
 ...
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="domain.cmd?$ACTION=list" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
