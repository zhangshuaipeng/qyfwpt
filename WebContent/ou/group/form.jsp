...
<div class="formarea" style="width:720px;">
 ...
 <htm:hidden name="owner" defaultv="{USERCODE}"/>
...
<table class="datatable" border="1" cellspacing="0" cellpadding="0" width="100%" align="center">
    <tbody>
        ...
        <tr>
            ...
            <td><htm:text name="name" title="名称" datatype="STRING" format="NOSPACE" required="true" maxlength="128" width="400"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="type"/>
</td>
            <td><htm:select name="type" title="类型" required="true" dictid="group"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="notes"/>
</td>
            <td><htm:textarea name="notes" title="说明" datatype="STRING" maxlength="255" height="50"/>
</td>
        </tr>
        <tr>
 ...
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="group.cmd?$ACTION=list" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
