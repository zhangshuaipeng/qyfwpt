...
<table width="100%" cellspacing="0" cellpadding="0" border="1" align="center" class="datatable">
    <tbody>
        <tr>
            <td style="width:150px;" class="caption"><htm:title name="cntcode"/>
</td>
            <td><htm:text name="cntcode" title="容器号" datatype="STRING" maxlength="32" width="256" unbitted="true"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="cntname"/>
</td>
            <td><htm:text name="cntname" title="容器名" datatype="STRING" maxlength="32" width="256"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="html"/>
</td>
            <td><htm:select name="html" title="引用子页面" required="true" dictid="include"/>
</td>
        </tr>
        <tr>
