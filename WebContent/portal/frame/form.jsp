...
<div class="formarea" style="width:1024px;">
  <div>
    ...
    <tbody>
        <tr>
            ...
            <td><htm:text name="code" title="窗体号" datatype="STRING" format="CODE" required="true" maxlength="32" width="256" unbitted="true"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="name"/>
</td>
            <td><htm:text name="name" title="窗体名" datatype="STRING" required="true" maxlength="32" width="256"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="icon"/>
</td>
            <td><htm:select name="icon" title="预览图片" dictid="frameimage"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><htm:editor name="html" height="500"/>
</td>
        </tr>
        <tr>
 ...
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="exit.gif" display="ICONTEXT" url="frame.cmd?$ACTION=list" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
