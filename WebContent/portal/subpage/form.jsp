...
<div class="formarea" style="width:1024px;">
  <div>
    ...
    <tbody>
        <tr>
            ...
            <td><htm:text name="code" title="子页面号" datatype="STRING" format="CODE" required="true" maxlength="32" width="256" unbitted="true"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="name"/>
</td>
            <td><htm:text name="name" title="子页面名" datatype="STRING" required="true" maxlength="32" width="400"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="type"/>
</td>
            <td><htm:select name="type" title="类型" required="true" dictid="includepage"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="css"/>
</td>
        ...
        <tr>
            ...
            <td><htm:editor name="html" height="600"/>
</td>
        </tr>
        <tr>
 ...
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="subpage.cmd?$ACTION=list" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
