...
<table class="datatable" border="1" cellspacing="0" cellpadding="0" width="100%" align="center">
    <tbody>
        ...
        <tr>
            ...
            <td><htm:span name="actorname"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="comment"/>
</td>
            <td><htm:span name="comment"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="result"/>
</td>
            <td style="color: red"><htm:span name="result" defaultv="工作已经成功提交!"/>
</td>
        </tr>
        <tr>
            <td colspan="2" align="center"><htm:button name="exit" value="返回" type="CLOSE" showtype="BUTTON" icon="exit.gif" display="ICONTEXT" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
