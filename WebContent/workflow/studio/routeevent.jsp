...
<htm:hidden name="$MESSAGE"/>
 ...
 <htm:hidden name="eventid" defaultv="onBeforeSelectActor"/>

<table width="100%" border="1" align="center" cellspacing="0" cellpadding="0" class="datatable" style="width:100%;">
    <tbody>
        <tr>
            <td style="width:80px;" class="caption"><htm:title name="event"/>
</td>
            <td><htm:select name="event" title="选择事件" required="true" defaultv="onBeforeSelectActor" dictid="routeevent" onchange="submitAjaxForm('saverouteevent');"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" colspan="2"><htm:button name="save" value="保存" type="CUSTOM" showtype="BUTTON" icon="update.gif" display="ICONTEXT" href="saverouteevent" target="_self" callback="closePopupWindow();" ajax="ajax"/>
