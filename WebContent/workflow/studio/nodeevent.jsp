...
<table width="100%" border="1" align="center" cellspacing="0" cellpadding="0" style="width:100%;" class="datatable">
    <tbody>
        <tr>
            <td class="caption" style="width:80px;"><htm:title name="event"/>
</td>
            <td><htm:select name="event" title="选择事件" required="true" defaultv="onInit" dictid="nodeevent" onchange="submitAjaxForm('savenodeevent');"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center" colspan="2"><htm:button name="save" value="保存" type="CUSTOM" showtype="BUTTON" icon="save1.gif" display="ICONTEXT" href="savenodeevent" target="_self" callback="closePopupWindow();" ajax="ajax"/>
