...
<table width="100%" cellspacing="0" cellpadding="0" border="1" align="center" class="datatable">
    <tbody>
        <tr>
            ...
            <td><htm:text name="code" title="模板号" datatype="STRING" required="true" maxlength="16" width="128"/>
</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="caption"><htm:title name="templtype"/>
</td>
            <td><htm:select name="templtype" title="模板类型" required="true" dictid="templettype"/>
</td>
        </tr>
        <tr>
            <td class="caption"><htm:title name="layoutid"/>
</td>
            <td><htm:text name="layoutid" title="布局号" datatype="STRING" maxlength="32" width="256"/>
</td>
        </tr>
        <tr>
 ...
 <htm:button name="exit" value="返回" type="URL" showtype="BUTTON" icon="return.gif" display="ICONTEXT" url="templet.cmd?$ACTION=list" args="siteid" target="_self"/>
</td>
        </tr>
    </tbody>
</table>
